import { AiOutlineHome, AiOutlineUser, AiOutlineLaptop, AiOutlineProject, AiOutlinePhone } from "react-icons/ai";
  ...
  return (
    <div className="sidebar w-full flex justify-center lg:hidden cursor-pointer fixed left-0 bottom-2 z-10">
      <div className="sidebar-menu px-5 flex items-center justify-center gap-x-3 py-2 text-sky-400 bg-gray-400 rounded-full bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10">
        <a
          href="#home"
          className="menu-item inline-flex items-center px-3 py-2 rounded-md md:hover:bg-gray-400 md:hover:rounded-md hover:bg-clip-padding md:hover:backdrop-filter md:hover:backdrop-blur-sm md:hover:bg-opacity-10 cursor-pointer">
          <div>
